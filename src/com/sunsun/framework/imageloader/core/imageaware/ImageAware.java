 ...
 *******************************************************************************/
package com.sunsun.framework.imageloader.core.imageaware;
 ...
 * {@link com.kugou.framework.imageloader.core.ImageLoader ImageLoader}. It can
 * wrap any Android {@link android.view.View View} which can be accessed by
 * {@link #getWrappedView()}. Wrapped view is returned in
 * {@link com.kugou.framework.imageloader.core.assist.ImageLoadingListener
...
public interface ImageAware {
	...
	/**
	 * Returns
	 * {@linkplain com.kugou.framework.imageloader.core.assist.ViewScaleType
	 ...
	 * and fires
	 * {@link com.kugou.framework.imageloader.core.assist.ImageLoadingListener#onLoadingCancelled(String, android.view.View)
	 ...
	 * {@linkplain com.kugou.framework.imageloader.core.DisplayImageOptions.Builder#showImageForEmptyUri(android.graphics.drawable.Drawable)
	 * for empty Uri},
	 * {@linkplain com.kugou.framework.imageloader.core.DisplayImageOptions.Builder#showImageOnLoading(android.graphics.drawable.Drawable)
	 * on loading} or
	 * {@linkplain com.kugou.framework.imageloader.core.DisplayImageOptions.Builder#showImageOnFail(android.graphics.drawable.Drawable)
	 * on loading fail}. These drawables can be specified in
	 * {@linkplain com.kugou.framework.imageloader.core.DisplayImageOptions
	 * display options}.
	 * 
	 ...
	 * used only in
	 * {@link com.kugou.framework.imageloader.core.display.BitmapDisplayer
	 * BitmapDisplayer}.
	 * 
