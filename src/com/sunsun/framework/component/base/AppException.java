...
public class AppException extends Exception {
	...
	protected static String mSavePaht = Environment
	 ...
	 * @param path
	 */
	public static void setSaveLogPah(String path) {
		mSavePaht = path;
	}
	...
	public static AppException http(int code) {
		return new AppException(TYPE_HTTP_CODE, code, new Exception(
				"error http responsecode:" + code));
	}
