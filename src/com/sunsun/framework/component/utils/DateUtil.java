...
public class DateUtil {
	 ...
	 * @return
	 */
	public static String twoDateDistance(Context context, Date startDate,
			Date endDate) {
	...
	public static String twoDateDistance(Context context, long startTime,
			long endTime) {
